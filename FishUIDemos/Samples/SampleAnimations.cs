...
namespace FishUIDemos
{
	...
	public class SampleAnimations : ISample
	{
		...
		public void Init()
		{
			...
			{
				fadeButton.FadeIn(FUI.Animations, 0.5f, Easing.EaseOutQuad);
			};
			...
			{
				fadeButton.FadeOut(FUI.Animations, 0.5f, Easing.EaseInQuad);
			};
			...
			{
				slideButton.SlideIn(FUI.Animations, new Vector2(-100, 0), 0.4f, Easing.EaseOutBack);
			};
			...
			{
				slideButton.SlideIn(FUI.Animations, new Vector2(0, -50), 0.4f, Easing.EaseOutBounce);
			};
			...
			{
				scaleButton.ScaleBounce(FUI.Animations, 1.2f, 0.3f);
			};
			...
			{
				scaleButton.AnimateSize(FUI.Animations, new Vector2(150, 40), 0.3f, Easing.EaseOutElastic);
			};
			...
			{
				scaleButton.AnimateSize(FUI.Animations, new Vector2(100, 30), 0.3f, Easing.EaseOutQuad);
			};
			...
			movePanelBtn.OnButtonPressed += (btn, mbtn, pos) =>
			{
				...
				animatedPanel.AnimatePosition(FUI.Animations, targetPos, 0.5f, Easing.EaseOutBack);
			};
			...
			foreach (var control in controls)
			{
				if (control is Panel panel && panel.Variant == PanelVariant.Highlight)
				{
					if (panelIndex < easings.Length)
					{
						...
						panel.AnimatePosition(FUI.Animations, new Vector2(targetX, panel.Position.Y), 1f, easings[panelIndex]);
						panelIndex++;
					}
				}
			}
