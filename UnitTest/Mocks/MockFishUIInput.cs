...
namespace UnitTest.Mocks
{
    ...
    public class MockFishUIInput : IFishUIInput
    {
        ...
        private readonly Queue<FishKey> _keyPressed = new();
        ...
        {
            GetKeyPressedCallCount++;
            return _keyPressed.Count == 0 ? FishKey.None : _keyPressed.Dequeue();
        }
