    ...
    public partial class ParticleEmitter : Control
    {
        ...
        protected override void OnFishUIUpdate(FishUI UI, float Dt, float Time)
        {
            ...
            for (int i = _particles.Count - 1; i >= 0; i--)
            {
                ...
                particle.Scale = Math.Max(0, particle.Scale + particle.ScaleSpeed * delta);
                ...
                float t = EasingFunctions.Apply(Config.ColorEasing, particle.NormalizedAge);
        ...
        public override void DrawControl(FishUI UI, float Dt, float Time)
        {
            ...
            // Render the state prepared during TickUpdate.
