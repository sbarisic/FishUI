...
namespace FishUI.Controls
{
    ...
    public abstract partial class Control
    {
        ...
        /// <summary>Called once for each consumed key-press event.</summary>
        public virtual void HandleKeyPressed(FishUI UI, FishInputState InState, FishKey Key)
        {
            HandleKeyPress(UI, InState, Key);
        }
        ...
        /// <summary>Called once per update while a previously pressed key remains held.</summary>
        public virtual void HandleKeyHeld(FishUI UI, FishInputState InState, FishKey Key)
        {
            HandleKeyDown(UI, InState, (int)Key);
        }
        ...
        /// <summary>Called once when a tracked held key is released.</summary>
        public virtual void HandleKeyReleased(FishUI UI, FishInputState InState, FishKey Key)
        {
            HandleKeyRelease(UI, InState, Key);
        }
