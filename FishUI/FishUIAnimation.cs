...
namespace FishUI
{
    ...
    public class FishUIAnimation
    {
        ...
        public float CurrentValue
        {
            get
            {
                ...
                float t = Duration <= 0f ? 1f : Math.Clamp((ElapsedTime - Delay) / Duration, 0f, 1f);
    ...
    public class FishUIAnimationManager
    {
        ...
        public FishUIAnimation Add(FishUIAnimation animation)
        {
            ...
            if (animation.Duration <= 0f && animation.Delay <= 0f)
            {
                animation.ElapsedTime = 0f;
                animation.ApplyValue?.Invoke(animation.EndValue);
